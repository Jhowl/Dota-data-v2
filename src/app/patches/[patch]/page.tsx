                ...
                <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                    ...
                    <div className="flex flex-col gap-2 sm:flex-row">
                        <Button asChild variant="outline" size="sm">
                            <Link href={`/patches/${encodeURIComponent(patchEntry.patch)}/handicap`}>Handicap Analysis</Link>
                        </Button>
                        <Button asChild variant="outline" size="sm">
                            <Link href={`/patches/${encodeURIComponent(patchEntry.patch)}/handicap/general`}>General Handicap Table</Link>
                        </Button>
                    </div>
                </div>
                <p className="max-w-2xl text-muted-foreground">Match trends and league activity captured during the {patchEntry.patch} meta.</p>
            </section>
